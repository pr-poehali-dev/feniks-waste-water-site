            ...
            {[
              {
                ...
                description: 'Высокоэффективные системы глубокой биологической очистки для предприятий и объектов ЖКХ. Производительность от 5 до 500 м³/сутки.',
                features: ['Степень очистки 98%', 'Автоматическое управление', 'Низкое энергопотребление'],
                icon: 'Recycle'
              },
              {
                title: 'Механические фильтры',
                description: 'Песчаные и картриджные фильтры для предварительной очистки воды от механических примесей и взвесей.',
                features: ['Высокая пропускная способность', 'Простое обслуживание', 'Долгий срок службы'],
                icon: 'Filter'
              },
              {
                title: 'Насосное оборудование',
                description: 'Погружные и поверхностные насосы для перекачки сточных вод различной степени загрязненности.',
                features: ['Надежная конструкция', 'Защита от перегрузок', 'Широкий диапазон мощности'],
                icon: 'Settings'
              },
              {
                title: 'УФ-обеззараживатели',
                description: 'Ультрафиолетовые установки для финальной дезинфекции очищенной воды без применения химических реагентов.',
                features: ['Экологичность', 'Высокая эффективность', 'Компактные размеры'],
                icon: 'Zap'
              },
              {
                title: 'Системы аэрации',
                description: 'Компрессоры и аэраторы для интенсификации биологических процессов очистки сточных вод.',
                features: ['Энергоэффективность', 'Бесшумная работа', 'Регулируемая производительность'],
                icon: 'Wind'
              },
              {
                title: 'Реагентное хозяйство',
                description: 'Дозирующие насосы, емкости и системы для подачи коагулянтов, флокулянтов и других реагентов.',
                features: ['Точное дозирование', 'Автоматический контроль', 'Коррозионная стойкость'],
                icon: 'Beaker'
              }
            ].map((item, index) => (
